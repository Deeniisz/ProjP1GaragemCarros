...
namespace ProjGaragemDeCarrosWebAppAPICORE.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public CarrosController(ProjGaragemDeCarrosWebAppAPICOREContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Renavam,Marca,Modelo,Cor,Ano,Preco")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Renavam,Marca,Modelo,Cor,Ano,Preco")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
