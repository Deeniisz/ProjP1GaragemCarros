...
namespace ProjGaragemDeCarrosWebAppAPICORE.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(ProjGaragemDeCarrosWebAppAPICOREContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CPF,Nome,Endereco,Email,Telefone")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CPF,Nome,Endereco,Email,Telefone")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
